...
| Status | Denotes the status of the tag: <br /> • **Production**: Displays the tags that are in production status. <br /> • **Staging**: Displays the tags that are in Staging status. <br /> • **Pending Publish**: Displays the tags that are yet to be published. <br /> • **Deleted**: Displays the tags that are deleted.|        
