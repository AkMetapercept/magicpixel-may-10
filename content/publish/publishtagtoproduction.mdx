...
metaTitle: 'Publish Tag to Production | Magic Pixel'
order: 3
--- 

# Publish the Tag to Production

On Magic Pixel, before publishing a tag to the Production environment, the tag must be first published to the Staging environment.

To publish a tag from staging to production environment, perform the following steps:
...
5. In the Publish Project to Production screen, review the tags, providers, triggers, transformers that are ready for production.
