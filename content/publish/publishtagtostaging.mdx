...
metaTitle: 'Publish Tag to Staging | Magic Pixel'
order: 2
--- 

# Publish the Tag to Staging

After creating a new tag on Magic Pixel, you must first publish the tag to the Staging Environment, and only then it can be published from Staging to the Production environment.
