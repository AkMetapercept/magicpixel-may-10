...
metaTitle: 'Qualification Criteria Screen | Magic Pixel'
order: 1
--- 
...
Filter the Qualification Criteria based on the following types:
...
This option allows to filter the Qualification Criteria based on the Data Elements.
